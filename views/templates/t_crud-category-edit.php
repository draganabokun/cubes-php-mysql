...
<div id="content">
    <div class="container portfolio">
        <div class="row">
            <div class="col-md-12">
                <h2>
                    CRUD Category - Edit category #<?php echo htmlspecialchars($category['id']); ?>
                </h2>
            </div>
        </div>
        <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                ...
                                <select name="group_id" class="form-control">
                                    ...
                                    <?php foreach ($groups as $group) { ?>
                                        <option value="<?php echo htmlspecialchars($group['id']); ?>"<?php echo isset($formData["group_id"]) && $formData["group_id"] == "option1" ? " selected=\"selected\"" : ""; ?>><?php echo htmlspecialchars($group['title']); ?></option>
                                    <?php } ?>
                                </select>
